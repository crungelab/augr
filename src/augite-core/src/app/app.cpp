...
#include <augite/viewer/viewer_manufacturer.h>
...
App::App() {
    ...
    REGISTER_MODEL_WIDGET_FACTORY(KnobIntWidget)
    ...
    REGISTER_VIEWER_FACTORY(DexieViewer)

    REGISTER_VIEWER_FACTORY(ProbeViewer)
